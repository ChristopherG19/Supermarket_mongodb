...
const Sales_table_item = ({ id, producto, precio, disponibilidad}) => {
  ...
  return (
    ...
    <tr className="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0">
        ...
        <td className="border-grey-light border hover:bg-gray-100 p-3 text-red-400 hover:text-red-600 hover:font-medium cursor-pointer">{disponibilidad}</td>
